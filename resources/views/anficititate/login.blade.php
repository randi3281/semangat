...
<div class="row justify-content-center" style="margin-top: -32px">
    <div class="col-sm-8 ">
        <form action="/anficititate/slc_repo" method="POST">
            ...
            <p style="font-size: 7pt">Lupa Kata Sandi? <a href="/anficititate/del_repo">Klik Disini</a></p>
            ...
            <div class="text-center mt-3">
                ...
                <p class="mt-2" style="font-size: 7pt">Belum Mempunyai Akun? <a href="/anficititate/daftar">Daftar
                        Disini</a></p>
            </div>
        </form>
    </div>
